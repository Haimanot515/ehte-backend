...
export class ReportService {
  ...
  async create(
    ...
    this.eventEmitter.emit(
      NotificationEventEnum.REPORT_RECEIVED,
      {
        reportId: report.id,
        userId: user.id,
      },
    ...
    this.eventEmitter.emit(
      NotificationEventEnum.NEW_REPORT,
      {
        reportId: report.id,
      },
    );
  ...
  async update(
    ...
    if (
      ...
      throw new BadRequestException(
        'only_pending_reports_can_be_updated',
      );
    }
    ...
    this.eventEmitter.emit(
      NotificationEventEnum.REPORT_UPDATED,
      {
        reportId: report.id,
        userId: user.id,
      },
  ...
  async escalate(
    ...
    this.eventEmitter.emit(
      NotificationEventEnum.HIGH_PRIORITY_REPORT,
      {
        reportId: report.id,
      },
    );
